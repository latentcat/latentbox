...
export const dataLlmGlobal: ResourceItem[] = [
  { id: "chatgpt", name: "ChatGPT", url: "https://chat.openai.com" },
  { id: "gemini", name: "Gemini", url: "https://gemini.google.com/" },
  { id: "claude", name: "Claude", url: "https://claude.ai/" },
  { id: "mistral", name: "Mistral", url: "https://chat.mistral.ai/" },
  { id: "llama-hugging-face-space", name: "Llama (Hugging Face Space)", url: "https://huggingface.co/spaces/huggingface-projects/llama-2-13b-chat" },
];

export const dataLlmChinese: ResourceItem[] = [
  { id: "zhi-pu-qing-yan", name: "智谱清言", url: "https://open.bigmodel.cn/" },
  ...
  { id: "wen-xin-yi-yan", name: "文心一言", url: "https://yiyan.baidu.com/" },
  { id: "tong-yi-qian-wen", name: "通义千问", url: "https://tongyi.aliyun.com/" },
...
export const dataSearch: ResourceItem[] = [
  { id: "perplexity", name: "Perplexity", url: "https://www.perplexity.ai/" },
  { id: "mi-ta-ai-sou-suo", name: "秘塔 AI 搜索", url: "https://metaso.cn/" },
  { id: "globe-explorer", name: "Globe Explorer", url: "https://explorer.globe.engineer/" },
  { id: "tian-gong-ai", name: "天工 AI", url: "https://search.tiangong.cn/" },
];

export const dataImage: ResourceItem[] = [
  { id: "dall-e-copilot-designer", name: "DALL-E (Copilot Designer)", url: "https://copilot.microsoft.com/images/create" },
  { id: "midjourney", name: "Midjourney", url: "https://www.midjourney.com/" },
  { id: "dreamstudio", name: "DreamStudio", url: "https://dreamstudio.ai/" },
  { id: "clipdrop", name: "Clipdrop", url: "https://clipdrop.co/" },
  { id: "krea-ai", name: "Krea.ai", url: "https://www.krea.ai/apps/image/realtime" },
  { id: "freepic-pikaso", name: "Freepic Pikaso", url: "https://freepik.com/pikaso" },
  { id: "imgpilot", name: "ImgPilot", url: "https://www.imgpilot.com/" },
  { id: "latent-consistency-fal-ai", name: "Latent Consistency (Fal.ai)", url: "https://fal.ai/dynamic" },
  { id: "blockadelabs", name: "Blockadelabs", url: "https://www.blockadelabs.com/" },
  { id: "deep-dream-generator", name: "Deep Dream Generator", url: "https://deepdreamgenerator.com/" },
...
export const dataVideo: ResourceItem[] = [
  ...
  { id: "stable-video-diffusion-fal-ai", name: "Stable Video Diffusion (Fal.ai)", url: "https://www.fal.ai/models/svd" },
  { id: "stable-video-diffusion-replicate", name: "Stable Video Diffusion (replicate)", url: "https://replicate.com/stability-ai/stable-video-diffusion" },
  { id: "animatediff-replicate", name: "AnimateDiff (replicate)", url: "https://replicate.com/lucataco/animate-diff" },
  { id: "kaiber", name: "Kaiber", url: "https://kaiber.ai/" },
  { id: "jian-ying-dreamina", name: "剪映 Dreamina", url: "https://www.capcut.cn/ai-tool/" },
...
export const dataMusic: ResourceItem[] = [
  ...
  { id: "kou-dai-yue-dui-app", name: "口袋乐队 app", url: "https://apps.apple.com/cn/app/%E5%8F%A3%E8%A2%8B%E4%B9%90%E9%98%9F-%E9%9F%B3%E4%B9%90%E5%88%B6%E4%BD%9C-%E5%94%B1%E6%AD%8C%E7%BC%96%E6%9B%B2-%E4%B9%90%E5%99%A8%E4%BC%B4%E5%A5%8F/id1603380354" },
  { id: "he-xian-pai-app", name: "和弦派 app", url: "https://www.lazycomposer.com/introduce" },
  { id: "x-studio", name: "X Studio", url: "https://xstudio.music.163.com/" },
...
export const dataVoice: ResourceItem[] = [
  ...
  { id: "xun-fei-zhi-zuo", name: "讯飞智作", url: "https://peiyin.xunfei.cn/" },
  { id: "jian-ying-ai-ke-lun-yin-se", name: "剪映 AI 克隆音色", url: "https://mp.weixin.qq.com/s/nHIPaq4evPbvSQS1ctYZrA" },
  { id: "zi-jie-huo-shan-yin", name: "字节火山语音", url: "https://www.volcengine.com/product/tts" },
  { id: "wei-ruan-yu-yin", name: "微软语音", url: "https://azure.microsoft.com/zh-cn/products/ai-services/text-to-speech/" },
  { id: "openai-voice-engine", name: "OpenAI Voice Engine", url: "https://openai.com/blog/navigating-the-challenges-and-opportunities-of-synthetic-voices" },
  { id: "da-bing-ai-bian-sheng", name: "大饼 AI 变声", url: "https://dubbing.tech/" },
];

export const dataDigitalHuman: ResourceItem[] = [
